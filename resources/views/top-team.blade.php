        ...
        <div class="col-2">
            <div class="dopdown-center my-2">
                ...
                <ul class="dropdown-menu">
                    <li><a href="/top-team" class="dropdown-item">Semua</a></li>
                    @foreach ($group as $g)
                        <li><a href="/top-team?group={{ $g->group }}" class="dropdown-item">{{ $g->group }}</a></li>
                    @endforeach
                </ul>
            </div>
        </div>
        ...
        @foreach ($team as $t)
            <div class="card my-2 py-2 px-3">
                <div class="row align-items-center">
                    ...
                    <div class="col-3 fw-bold">{{ $t->name }}</div>
                    ...
                    <div class="col-1">Goal <i class="fa-solid fa-futbol"></i>: {{ $t->goal_count }}</div>
                </div>
            </div>
        @endforeach
    </div>
